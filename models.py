...
class Generator(nn.Module):
    ...
    def __init__(self, use_skips):
        super().__init__()
        self.use_skips = use_skips
        self.conv_transpose = nn.ConvTranspose2d(256, 1024, kernel_size=4,
                                                 stride=1, padding=0)
        self.batchnorm = nn.BatchNorm2d(1024)
        self.glu = nn.GLU() # cuts number of channels in half
        self.upsampler_4 = Upsampler(512, 512)
        self.upsampler_8 = Upsampler(512, 512)
        self.upsampler_16 = Upsampler(512, 256)
        self.upsampler_32 = Upsampler(256, 128)
        ...
        if use_skips:
            ...
            self.skip_16_256 = SkipLayerExcitation(32, 512)
            self.skip_32_512 = SkipLayerExcitation(3, 256)
    ...
    def forward(self, x):
        ...
        x_1024 = self.upsampler_512(x_512)
        return self.nonlinear(self.conv(x_1024))
...
class SimpleDecoder(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.upsampler1 = Upsampler(256, 128)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, use_decoders):
        super().__init__()
